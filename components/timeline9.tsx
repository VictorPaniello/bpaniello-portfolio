  ...
  return (
    <section className={cn("py-32", className)}>
      <div className="container space-y-10 lg:space-y-20">
        <h1 className="text-center text-4xl font-semibold tracking-tighter text-foreground sm:text-6xl">
          Education
        </h1>
        <div className="relative mx-auto max-w-4xl">
          ...
          {timelineData.map((entry, index) => (
            <div key={index} className="relative mb-10 pl-8">
              ...
              <h4 className="rounded-xl py-2 text-xl text-foreground font-bold tracking-tighter xl:mb-4 xl:px-3">
                {entry.title}
              </h4>

              <h5 className="text-md top-3 -left-34 rounded-xl tracking-tighter text-muted-foreground xl:absolute">
                {entry.date}
              </h5>
